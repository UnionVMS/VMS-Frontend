...
import { FishingActivityModule } from './modules/fishing-activity/fishing-activity.module';
...
import { FishingActivityEffects } from '@data/fishing-activity/fishing-activity.effects';
